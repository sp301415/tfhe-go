...
func (e Evaluater[T]) ToFourierGLWECiphertext(ct GLWECiphertext[T]) FourierGLWECiphertext[T] {
...
func (e Evaluater[T]) ToFourierGLWECiphertextInPlace(ctIn GLWECiphertext[T], ctOut FourierGLWECiphertext[T]) {
...
func (e Evaluater[T]) ToStandardGLWECiphertext(ct FourierGLWECiphertext[T]) GLWECiphertext[T] {
...
func (e Evaluater[T]) ToStandardGLWECiphertextInPlace(ctIn FourierGLWECiphertext[T], ctOut GLWECiphertext[T]) {
	for i := 0; i < e.Parameters.glweDimension+1; i++ {
...
func (e Evaluater[T]) ToFourierGLevCiphertext(ct GLevCiphertext[T]) FourierGLevCiphertext[T] {
...
func (e Evaluater[T]) ToFourierGLevCiphertextInPlace(ctIn GLevCiphertext[T], ctOut FourierGLevCiphertext[T]) {
...
func (e Evaluater[T]) ToStandardGLevCiphertext(ct FourierGLevCiphertext[T]) GLevCiphertext[T] {
...
func (e Evaluater[T]) ToStandardGLevCiphertextInPlace(ctIn FourierGLevCiphertext[T], ctOut GLevCiphertext[T]) {
	for i := 0; i < ctIn.decompParams.level; i++ {
...
func (e Evaluater[T]) ToFourierGGSWCiphertext(ct GGSWCiphertext[T]) FourierGGSWCiphertext[T] {
...
func (e Evaluater[T]) ToFourierGGSWCiphertextInPlace(ctIn GGSWCiphertext[T], ctOut FourierGGSWCiphertext[T]) {
	for i := 0; i < e.Parameters.glweDimension+1; i++ {
...
func (e Evaluater[T]) ToStandardGGSWCiphertext(ct FourierGGSWCiphertext[T]) GGSWCiphertext[T] {
...
func (e Evaluater[T]) ToStandardGGSWCiphertextInPlace(ctIn FourierGGSWCiphertext[T], ctOut GGSWCiphertext[T]) {
	for i := 0; i < e.Parameters.glweDimension+1; i++ {
		e.ToStandardGLevCiphertextInPlace(ctIn.Value[i], ctOut.Value[i])
	}
}

/* Same methods, but for encrypter */
