...
func monomialDivSubAddAssignUint32AVX2(p0 []uint32, d int, pOut []uint32)
func monomialDivSubAddAssignUint64AVX2(p0 []uint64, d int, pOut []uint64)
...
func monomialDivSubAddAssign[T Tint](p0 poly.Poly[T], d int, pOut poly.Poly[T]) {
	if cpu.X86.HasAVX2 {
		...
		switch any(z).(type) {
		case uint32:
			monomialDivSubAddAssignUint32AVX2(
		...
		case uint64:
			monomialDivSubAddAssignUint64AVX2(
...
func monomialDivSubAssignUint32AVX2(p0 []uint32, d int, pOut []uint32)
func monomialDivSubAssignUint64AVX2(p0 []uint64, d int, pOut []uint64)
...
func monomialDivSubAssign[T Tint](p0 poly.Poly[T], d int, pOut poly.Poly[T]) {
	if cpu.X86.HasAVX2 {
		...
		switch any(z).(type) {
		case uint32:
			monomialDivSubAssignUint32AVX2(
				*(*[]uint32)(unsafe.Pointer(&p0)),
				d,
				*(*[]uint32)(unsafe.Pointer(&pOut)),
			)
		...
		case uint64:
			monomialDivSubAssignUint64AVX2(
				*(*[]uint64)(unsafe.Pointer(&p0)),
				d,
				*(*[]uint64)(unsafe.Pointer(&pOut)),
			)
