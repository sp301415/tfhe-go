...
var (
	...
	ParamsBinaryLUT2 = tfhe.ParametersLiteral[uint32]{
		LWEDimension:    687,
		GLWERank:        2,
		PolyDegree:      512,
		LookUpTableSize: 512,
	...
	ParamsBinaryCompactLUT2 = tfhe.ParametersLiteral[uint32]{
		LWEDimension:    687,
		GLWERank:        2,
		PolyDegree:      512,
		LookUpTableSize: 512,
	...
	ParamsUint2LUT4 = tfhe.ParametersLiteral[uint64]{
		LWEDimension:    804,
		GLWERank:        1,
		PolyDegree:      2048,
	...
	ParamsUint3LUT2 = tfhe.ParametersLiteral[uint64]{
		LWEDimension:    804,
		GLWERank:        1,
		PolyDegree:      2048,
		LookUpTableSize: 2048,
