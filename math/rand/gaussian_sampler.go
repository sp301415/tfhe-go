...
// Some modifications were made to use crypto/rand instead of Rand.
// See: https://go.dev/src/math/rand/normal.go
...
func (r GaussianSampler[T]) NormFloat64() float64 {
	for {
...
// See: https://go.dev/src/math/rand/rand.go
func (r GaussianSampler[T]) float64() float64 {
