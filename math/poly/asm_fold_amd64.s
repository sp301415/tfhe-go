...
// Requires: AVX
TEXT ·foldPolyToUint32AVX2(SB), NOSPLIT, $0-48
	MOVQ fpOut_base+0(FP), AX
	MOVQ p_base+24(FP), CX
	MOVQ fpOut_len+8(FP), DX
	MOVQ DX, BX
	SHRQ $0x01, BX
	XORQ SI, SI
	XORQ DI, DI
...
// Requires: AVX, AVX2
TEXT ·foldPolyToUint64AVX2(SB), NOSPLIT, $0-48
	MOVQ         fpOut_base+0(FP), AX
	MOVQ         p_base+24(FP), CX
	MOVQ         fpOut_len+8(FP), DX
	MOVQ         DX, BX
...
// Requires: AVX
TEXT ·unfoldPolyToUint32AVX2(SB), NOSPLIT, $0-48
...
// Requires: AVX, AVX2
TEXT ·unfoldPolySubToUint64AVX2(SB), NOSPLIT, $0-48
	MOVQ         pOut_base+0(FP), AX
	MOVQ         fp_base+24(FP), CX
	MOVQ         fp_len+32(FP), DX
	MOVQ         DX, BX
