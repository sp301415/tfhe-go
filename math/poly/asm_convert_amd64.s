...
GLOBL EXP5251<>+0(SB), NOPTR | RODATA, $8
DATA EXP32<>+0(SB)/8, $0x41f0000000000000 // 2^32
GLOBL EXP32<>+0(SB), NOPTR | RODATA, $8
DATA EXP32INV<>+0(SB)/8, $0x3df0000000000000 // 2^-32
GLOBL EXP32INV<>+0(SB), NOPTR | RODATA, $8
...
#define FLOAT64_TO_INT64(EXP5251, IN, OUT) \
	VADDPD EXP5251, IN, OUT  \
	VPSUBQ EXP5251, OUT, OUT \

#define INT64_TO_FLOAT64(EXP5251, IN, OUT) \
	VPADDQ EXP5251, IN, OUT  \
	VSUBPD EXP5251, OUT, OUT \
...
loop_body:
	...
	FLOAT64_TO_INT64(Y12, Y2, Y2)

	INT64_TO_FLOAT64(Y12, Y2, Y3)
	VMULPD Y3, Y10, Y3
	VSUBPD Y3, Y0, Y3
	FLOAT64_TO_INT64(Y12, Y3, Y3)
	...
	FLOAT64_TO_INT64(Y12, Y5, Y5)

	INT64_TO_FLOAT64(Y12, Y5, Y6)
	VMULPD Y6, Y10, Y6
	VSUBPD Y6, Y1, Y6
	FLOAT64_TO_INT64(Y12, Y6, Y6)
