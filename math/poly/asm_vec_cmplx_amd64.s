...
TEXT ·floatMulAddCmplxAssignAVX2(SB), $0-56
	MOVQ v0+0(FP), AX
	MOVQ vOut+32(FP), CX
...
TEXT ·floatMulSubCmplxAssignAVX2(SB), $0-56
	MOVQ v0+0(FP), AX
	MOVQ vOut+32(FP), CX
...
TEXT ·cmplxMulCmplxAssignAVX2(SB), $0-64
	MOVQ v0+0(FP), AX
	MOVQ vOut+40(FP), CX
...
TEXT ·cmplxMulAddCmplxAssignAVX2(SB), $0-64
	MOVQ v0+0(FP), AX
	MOVQ vOut+40(FP), CX
...
TEXT ·cmplxMulSubCmplxAssignAVX2(SB), $0-64
	MOVQ v0+0(FP), AX
	MOVQ vOut+40(FP), CX
