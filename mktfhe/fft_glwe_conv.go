...
// ToFFTGLWESecretKey transforms GLWE secret key to FFT GLWE secret key.
...
// ToFFTGLWESecretKeyTo transforms GLWE secret key to FFT GLWE secret key and writes it to skOut.
...
// ToGLWESecretKey transforms FFT GLWE secret key to GLWE secret key.
...
// ToGLWESecretKeyTo transforms FFT GLWE secret key to GLWE secret key and writes it to skOut.
...
// ToFFTGLWECiphertext transforms GLWE ciphertext to FFT GLWE ciphertext.
...
// ToFFTGLWECiphertextTo transforms GLWE ciphertext to FFT GLWE ciphertext and writes it to ctOut.
...
// ToGLWECiphertext transforms FFT GLWE ciphertext to GLWE ciphertext.
...
// ToGLWECiphertextTo transforms FFT GLWE ciphertext to GLWE ciphertext and writes it to ctOut.
...
// ToFFTUniEncryption transforms UniEncryption to FFT UniEncryption.
...
// ToFFTUniEncryptionTo transforms UniEncryption to FFT UniEncryption and writes it to ctOut.
...
// ToUniEncryption transforms FFT UniEncryption to UniEncryption.
...
// ToUniEncryptionTo transforms FFT UniEncryption to UniEncryption and writes it to ctOut.
